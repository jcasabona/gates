...
class gates_recent_posts extends WP_Widget {

	function __construct() {
        $widget_ops = array( 'classname' => 'gates_recent_posts_widget', 'description' => __('Displays recent blog entries.', 'gates') );
        parent::__construct( 'gates_recent_posts_widget', __('Recent Posts','gates'), $widget_ops );
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('widget_title'); ?>"><?php  _e('Title', 'gates'); ?>:
		...
		<p>
			<label for="<?php echo $this->get_field_id('number_of_posts'); ?>"><?php _e('Number of posts to display', 'gates'); ?>:
...
register_widget('gates_recent_posts'); ?>