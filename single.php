		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<?php if ( $post_format == 'gallery' ) : ?>
				...
				<div class="featured-media">	
					...
					<?php gates_flexslider('post-image'); ?>
			...
			<div class="post-inner section-inner <?php if ( ! is_learndash_type() ) { echo 'thin'; } ?>">
			
				<div class="post-header">
				<?php 
					if ( ! is_learndash_type() ) { 
						get_template_part( 'parts/single', 'top-meta' );
					}
				?>
			    ...
			    <div class="post-content">
			    	...
			    	<?php 
				    	$args = array(
							'before'           => '<div class="clear"></div><p class="page-links"><span class="title">' . __( 'Pages:','gates' ) . '</span>',
							'after'            => '</p>',
							'link_before'      => '<span>',
							'link_after'       => '</span>',
							'separator'        => '',
				...
				<ul>
					...
					<li>
						<a class="active tab-comments" href="#">
							...
							<span><?php _e('Comments','gates'); ?></span>
						</a>
					</li>
					<li>
						<a class="tab-post-meta" href="#">
							<div class="genericon genericon-summary"></div>
							<span><?php _e('Post info','gates'); ?></span>
						</a>
					</li>
					<li>
						<a class="tab-author-meta" href="#">
							<div class="genericon genericon-user"></div>
							<span><?php _e('Author info','gates'); ?></span>
						</a>
					</li>
			...
			<div class="tab-post-meta tab">
				...
				<div class="post-nav one-third">
					...
					if (!empty( $next_post )): ?>
						...
						<a class="post-nav-newer" title="<?php _e('Next post:', 'gates'); echo ' ' . get_the_title($next_post); ?>" href="<?php echo get_permalink( $next_post->ID ); ?>">
							<p><?php _e('Next post','gates'); ?></p>
					...
					if (!empty( $prev_post )): ?>
						...
						<a class="post-nav-older" title="<?php _e('Previous post:', 'gates'); echo ' ' . get_the_title($prev_post); ?>" href="<?php echo get_permalink( $prev_post->ID ); ?>">
							<p><?php _e('Previous post','gates'); ?></p>
